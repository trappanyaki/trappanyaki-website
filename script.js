...
(function () {
  ...
  var Ticker = (function ticker() {
    ...
    if (marquee) {
      var strip =
        ...
        '<span>TRACY &amp; STOCKTON, CA</span><span>·</span>' +
  ...
  (function quotes() {
    ...
    function show(i) {
      ...
      items.forEach(function (q, n) { q.classList.toggle('is-live', n === index); });
  ...
  /* ==========================================================
     6 · BATCH-SLOT BUILDER (hard cap: 8 plates)
     ========================================================== */
  (function builder() {
    var list = $('#plate-list');
    if (!list) return;
